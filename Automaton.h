...
#ifndef INC_236PROJECT1_0_AUTOMATON_H
#define INC_236PROJECT1_0_AUTOMATON_H
#include "Token.h"
class Automaton
{
protected:
...
public:
    ...
    virtual unsigned int Start(const std::string& input) {
        newLines = 0;
        inputRead = 0;
        index = 0;
        S0(input);
...
#endif //INC_236PROJECT1_0_AUTOMATON_H
